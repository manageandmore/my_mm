...
export async function generatePostImage(
  ...
  const [mmLogo, utumLogo, workSansRegular, workSansBold] = await Promise.all([
    ...
    fetch(new URL("../../../assets/utum_logo.png", import.meta.url)).then(
      (res) => res.arrayBuffer()
    ),
    fetch(
    ...
    fetch(
      new URL("../../../assets/fonts/WorkSans-Bold.ttf", import.meta.url)
    ).then((res) => res.arrayBuffer()),
  ]);
  ...
  return new ImageResponse(
    {
      ...
      props: {
        style: {
          ...
          flexDirection:
            options.logoPosition == "top" ? "column" : "column-reverse",
          flexWrap: "nowrap",
        },
        children: [
          {
          ...
          },
          {
            ...
            props: {
              style: {
                ...
                justifyContent: "space-between",
                alignItems:
                  options.logoPosition == "top" ? "flex-start" : "flex-end",
              ...
              children: [
                {
                  type: "img",
                  key: null,
                  props: { height: options.size * 0.06, src: mmLogo },
                },
                {
                  type: "img",
                  key: null,
                  props: { height: options.size * 0.09, src: utumLogo },
                },
              ],
            },
          },
          {
            ...
            props: {
              style: {
                ...
                flexWrap: "nowrap",
                alignItems:
                  options.titleAlignment == "left" ? "flex-start" : "flex-end",
                fontFamily: "WorkSans",
                color: "white",
