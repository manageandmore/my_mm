 ...
 */
export function getAddSkillModal(skillList: SkillItems): ModalView {
  console.log("skill List",JSON.stringify(skillList));
  return {
    type: "modal",
    private_metadata: JSON.stringify(skillList),
    callback_id: addSkillItemAction,
    title: {
      type: "plain_text",
      text: "New Skill",
      emoji: false,
