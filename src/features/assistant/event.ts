import {  AnyMessageBlock, AnyTextField, ChatPostMessageResponse, MessageAttachment } from "slack-edge";
...
async function createLoadingMessage(channel: string): Promise<ChatPostMessageResponse> {
